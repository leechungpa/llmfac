...
OUTDIR="./results/${category}/${model_name_or_path}/"
...
llamafactory-cli train scripts/train.yaml \
  ...
  dataset="mmlu_train_cot_s5_${category}"
...
for i in 2 3 4 5 6; do
  ...
  llamafactory-cli train scripts/train.yaml \
    ...
    dataset="mmlu_train_cot_s${nshot}_${category}"
...
llamafactory-cli train scripts/train.yaml \
  ...
  lora_rank="$rank" \
  output_dir="${OUTDIR}${suffix}_epoch1" \
  dataset="mmlu_train_cot_s5_${category},mmlu_train_cot_s0_${category}" \
